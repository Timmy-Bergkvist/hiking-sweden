...
function writeNote () {
  ...
  document.getElementById('read_form').style.display ="none";
...
function readNotes(){
  ...
  document.getElementById('read_form').style.display ="block";
  document.getElementById('note_form').style.display ="none";
}

function dispalyNote(note){
